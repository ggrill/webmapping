...
var legends = {
    'dis_m3_pyr': [
        [0, 10, 50, 100, 1000, 10000, 25000, 50000],
        ["hsl(207, 88%, 80%)", "hsl(207, 89%, 70%)", "hsl(207, 89%, 60%)", "hsl(207, 89%, 50%)", "hsl(207, 89%, 40%)", "hsl(207, 89%, 30%)", "hsl(207, 89%, 20%)", "hsl(207, 89%, 10%)"],
        "Natural Discharge (m3)"
    ],
    'pac_pc_sse': [
        [0, 1, 10, 50, 99, 100],
        ["hsl(0,0%,70%)", "hsl(199,98%,61%)", "hsl(314,73%,24%)", "hsl(5,80%,55%)", "hsl(33,74%,50%)", "hsl(50,100%,52%)"],
        "Protected Areas (%)"
    ],
    'ari_ix_sav': [
        [0, 1, 50, 100, 150, 200],
